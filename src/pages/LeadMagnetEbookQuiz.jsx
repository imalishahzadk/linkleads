...
const Store = () => {
  ...
  useEffect(() => {
    const fetchEbooks = async () => {
      try {
        const response = await axios.get("/ebook/all?username=" + username, {
          headers: {
    ...
    const fetchLandingData = async () => {
      try {
        const response = await axios.get(
          "/lead-magnet/get-ebook-landing-page?username=" + username,
          {
            headers: {
              "Content-Type": "application/json",
            },
              ...
              {currentStep === 3 && (
                <>
                  ...
                  >
                    ...
                    eBooks. Select and continue to view mini landing page with
